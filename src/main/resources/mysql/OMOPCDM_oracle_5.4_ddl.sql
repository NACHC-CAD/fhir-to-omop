-- oracle CDM DDL Specification for OMOP Common Data Model 5.4

drop schema if exists synthea_omop;

create schema synthea_omop;
...
CREATE TABLE MEASUREMENT (
			...
			measurement_event_id BIGINT(19) NULL,
...
CREATE TABLE OBSERVATION (
			...
			value_source_value varchar(50) NULL,
			observation_event_id BIGINT(19) NULL,
...
CREATE TABLE EPISODE (
			...
			episode_parent_id BIGINT(19) NULL,
